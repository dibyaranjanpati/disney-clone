  ...
  return (
    <div className="flex gap-2  md:gap-6 p-2 px-5 md:px-16">
      {productionHouseList.map((item, i) => (
        <div
          className="border-[2px] border-gray-600 rounded-lg hover:scale-110 translate-all duration-300 ease-in-out cursor-pointer relative shadow-xl shadow-gray-800"
          key={i}
        >
          <video
            src={item.video}
